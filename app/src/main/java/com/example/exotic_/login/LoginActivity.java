package com.example.exotic_.login;
...
//                    String status1 = String.valueOf((dataSnapshot.child("status").getValue()));
                    ...
                    if (dataSnapshot.child("statusAkun").exists()) {
                        if(dataSnapshot.child("statusAkun").getValue(String.class).equals("KASIR")){
                            startActivity(new Intent(getBaseContext(), KasirActivity.class));
