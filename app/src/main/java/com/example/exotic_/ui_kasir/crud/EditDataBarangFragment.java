...
public class EditDataBarangFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        GambarBarang = root.findViewById(R.id.image_view_gambar_barang);
        ...
        JenisBarang.setText(KasirActivity.jenisBarang);
        HargaBarang.setText(KasirActivity.hargabarang);
        JumlahBarang.setText(KasirActivity.jumlahbarang);
        Picasso.get()
                .load(KasirActivity.gambar)
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    Barang upload = new Barang(NamaBarang.getText().toString().trim(),
                                            ...
                                            uri.toString());
                                    //String uploadId = mDatabaseRef.push().getKey();
                                    DatabaseRefBarang.child(KasirActivity.referenceKeyBarang).setValue(upload);
                                }
                            });
